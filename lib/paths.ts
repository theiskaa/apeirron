...
export const READING_PATHS: ReadingPath[] = [
  {
    ...
    nodes: [
      ...
      { id: "bcci-nugan-hand", hook: "And here are the banks underneath all of it. Twice, a generation apart, an institution surfaced that was half real bank, half covert utility — Nugan Hand in Sydney, its board a reunion of CIA brass, its founder shot dead in his Mercedes with a former DCI's card in the Bible beside him; then BCCI, the largest bank fraud in history, which moved the cartel's money and the Agency's through the same pipes and secretly bought the biggest bank in Washington with Clark Clifford as its mask. Money beyond any appropriation or audit — the financial organ the whole sequence runs on", parents: ["iran-contra", "operation-cyclone"] },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "economic-hitman", hook: "Follow the loan. John Perkins says his job was to bury nations under infrastructure debt they could never repay — and when a president refused the deal, the 'jackals' came. Two Latin American leaders who said no died in plane crashes within months of each other in 1981", parents: ["federal-reserve"] },
      { id: "money-as-debt", hook: "The dollar in your account was conjured from nothing the moment a bank made a loan — and the Bank of England admitted it in 2014. If money is created as debt, the debt can never be repaid, and perpetual growth stops being a policy choice and becomes a law of survival", parents: ["federal-reserve"] },
      { id: "petrodollar", hook: "1971: Nixon cuts the dollar's last tie to gold. 1974: a secret deal binds Saudi oil to the dollar and the dollar to U.S. Treasuries. The hidden engine that lets America run the deficits the rest of the world is quietly forced to finance", parents: ["money-as-debt"] },
      { id: "military-industrial-complex", hook: "A five-star general's last warning. January 1961: Eisenhower tells the nation to guard against the 'military-industrial complex' — and the early draft named Congress too. The permanent war economy that manufactures the very threats it feeds on", parents: ["deep-state"] },
      { id: "shock-doctrine", hook: "September 11, 1973: La Moneda burns, Allende is dead, and within days a 500-page free-market blueprint — 'The Brick,' drafted by Friedman's Chicago Boys — is on Pinochet's desk. Naomi Klein's thesis for how the machine installs itself: not by persuasion but in the disorientation of crisis, when the population cannot resist", parents: ["control-systems"] },
      { id: "manufacturing-consent", hook: "Chomsky and Herman's five filters. The press isn't censored — it doesn't need to be. Ownership, advertising, sourcing, flak, and a unifying enemy quietly set the boundaries of the thinkable, and everything inside them is called free debate", parents: ["bernays"] },
      { id: "frankfurt-school", hook: "A circle of exiled German Marxists who turned from economics to culture — and whose 'culture industry' critique became, decades later, the most contested conspiracy theory of the modern right. The serious scholarship and the weaponized myth, finally told apart", parents: ["counterculture-psyop"] },
      { id: "cbdc", hook: "Programmable money. In 2020 the head of the Bank for International Settlements said it plainly: with a central-bank digital currency, the issuer will have 'absolute control' over how every unit can be spent — and the technology to enforce it", parents: ["mass-surveillance"] },
      { id: "hypernormalisation", hook: "Adam Curtis borrowed a word the late Soviets lived by: everyone knew the system was fake, and everyone performed belief anyway. His argument that since 1975 our managers retreated from a real, complex world into a simpler, fabricated one — and took us with them", parents: ["predictive-programming"] },
    ],
  },
  {
    id: "the-hidden-hand",
    ...
    nodes: [
      ...
      { id: "p2-banco-ambrosiano", hook: "And here is the lodge that stopped being a metaphor. Propaganda Due — 962 names pulled from a Tuscan villa in 1981, every Italian intelligence chief on the roster, a typed plan to capture the state — ran two banks and a Vatican account until the billion went missing and the bodies started. Roberto Calvi, God's Banker, hanged under Blackfriars Bridge with bricks in his pockets; Michele Sindona, cyanide in his prison coffee. The secret-society thesis with a paper trail and a morgue — and almost no one convicted", parents: ["freemasonry"] },
      { id: "pope-john-paul-i", hook: "And here is the same lodge story at its deadliest. September 1978: a reformer pope, 33 days on the throne, allegedly holding a list of Vatican officials secretly sworn to the illegal P2 lodge — found dead in his bed before he could act, no autopsy, the body embalmed within a day, the account of who found him quietly falsified. Whether murdered or merely failed by a viper's-nest Curia, John Paul I is the case where the secret-society-inside-the-institution thesis acquired a corpse", parents: ["p2-banco-ambrosiano"] },
      ...
      { id: "agenda-21", hook: "Rio, 1992. A non-binding UN action plan for 'sustainable development' — and the longest-running fear in American conspiracy culture: that 'sustainability' is the polite name for abolishing private property and herding people into managed zones", parents: ["great-reset"] },
      { id: "georgia-guidestones", hook: "1980, rural Georgia: a stranger calling himself R.C. Christian commissions a granite monument whose first commandment is to keep humanity under 500 million. The 'American Stonehenge' — blown up by persons unknown in 2022, the mystery still sealed", parents: ["new-world-order"] },
      { id: "technocracy", hook: "Rule by engineers, value measured in energy instead of money. A fringe 1930s movement that fizzled — but whose dream of administration-by-expert, Patrick Wood argues, came back through the Trilateral Commission and the language of sustainable development", parents: ["great-reset"] },
      { id: "transhumanism", hook: "Merge with the machine. From Julian Huxley's 1957 coinage to Kurzweil's 2045 Singularity to Davos's 'Fourth Industrial Revolution' — the project to re-engineer the human, and the fear that it will be done to us rather than chosen by us", parents: ["great-reset"] },
      { id: "venus-project", hook: "Jacque Fresco spent his life designing a world without money — a 'resource-based economy' of automation and abundance, the cure Zeitgeist offered for the debt-empire it exposed. Utopia, or central planning's oldest impossible dream rebuilt in white domes?", parents: ["technocracy"] },
    ],
  },
  {
    id: "the-dynasties",
    ...
    nodes: [
      ...
      { id: "the-corporation", hook: "Before the dynasty, the legal machine that made it possible. In 1886 a court reporter's headnote — not a ruling — declared the corporation a 'person' under the 14th Amendment, and a clerk's marginal note became a century of law. Joel Bakan asks what kind of person we built: run the corporation against the FBI's psychopathy checklist and it fits", parents: ["rockefeller"] },
      { id: "eugenics", hook: "Before the Holocaust, the science was American. Galton's 'better breeding,' Rockefeller and Carnegie money, 60,000 forced sterilizations the Supreme Court upheld — 'three generations of imbeciles are enough' — and a transatlantic loop that fed Nazi racial law. The dynasty's darkest export, and the question of what 'the new eugenics' means now", parents: ["rockefeller"] },
      { id: "club-of-rome", hook: "1968: an elite circle of industrialists and scientists convenes to manage humanity's future. Their 1972 computer model predicted civilizational overshoot — and a 1991 line about humanity itself being 'the common enemy' has been quoted ever since as the mask slipping", parents: ["cfr-trilateral"] },
    ],
  },
  {
    ...
    nodes: [
      ...
      { id: "amerithrax", hook: "One week after the towers, the mail turned lethal. Five dead from a powder so fine it floated — and the FBI spent a decade chasing it, past one innocent man it publicly destroyed, to a government bioweapons scientist who killed himself before any trial. The anthrax was American, traced to the Army's own lab; the letters were printed to read as jihadist; and the only two weapons-grade envelopes went to the two senators slowing the Patriot Act. Closed, never tried", parents: ["nine-eleven"] },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "the-aether", hook: "In 1887 an experiment failed to find the medium light was supposed to travel through, and physics declared the aether dead. Then quantum theory filled empty space with seething energy and Tesla insisted the void was full. The ghost that keeps coming back", parents: ["tesla-suppressed-tech"] },
      { id: "wilhelm-reich", hook: "Freud's most brilliant student claimed to find a life-energy he called orgone — and in 1956 the U.S. government burned his books by the ton and let him die in prison. The clearest case of the state destroying an idea it could not refute, whatever orgone actually was", parents: ["tesla-suppressed-tech"] },
    ],
  },
  {
    id: "lost-worlds",
    ...
    nodes: [
      ...
      { id: "astrotheology", hook: "What if the Gospel is the sky? The claim that Jesus is the sun's annual journey retold — the zodiac as twelve disciples, the cross as the equinoxes, December 25 as the solstice rebirth. Zeitgeist made it famous and got much of it wrong; the serious core survives anyway", parents: ["ancient-astronauts"] },
      { id: "anunnaki", hook: "Zecharia Sitchin read the Sumerian tablets and found a creation story: gods from a planet called Nibiru who came to mine gold and engineered us from clay and their own blood. The Assyriologists say he mistranslated everything. Where the ancient-astronaut thesis gets its scripture", parents: ["nibiru"] },
    ],
  },
  {
    ...
    nodes: [
      ...
      { id: "pineal-gland", hook: "Descartes called it the seat of the soul; Hindu tradition calls it the third eye. And one researcher thinks this pea-sized gland may secrete DMT — the molecule of visions — making the bridge between matter and spirit a piece of anatomy", parents: ["altered-states"] },
      { id: "kundalini", hook: "A serpent coiled at the base of the spine, waiting. The yogic map of an energy that, awakened, rises through seven centers to dissolve the self in light — drug-free technology for the same states the psychedelics reach, or the body's most elaborate metaphor", parents: ["altered-states"] },
      { id: "stoned-ape", hook: "Terence McKenna's wager on how we became human: that early hominids eating psilocybin mushrooms on the savannah got the visual edge, the language, and the religious imagination that made us us. Unprovable, unforgettable, and a direct challenge to the prohibition", parents: ["altered-states"] },
      { id: "maya-nonduality", hook: "The oldest and most radical idealism: that the world of separate things is appearance — maya — and the only reality is the single awareness you already are. 'Tat tvam asi.' The simulation hypothesis is this intuition in computational dress", parents: ["idealism"] },
      { id: "illusion-of-self", hook: "Look for the self and you won't find it — only a bundle of perceptions, said Hume; only a model the brain spins, says neuroscience. The default-mode network and the meditators arrive at the same vertigo: the one who is reading this may not exist", parents: ["consciousness"] },
      { id: "quantum-consciousness", hook: "Watch the electron and it stops behaving like a wave. From there a minority of physicists drew the boldest claim in science — that consciousness collapses reality — and Penrose went looking for mind in the quantum structure of the brain. The mainstream's answer, decoherence, is just as strange", parents: ["consciousness"] },
      { id: "holographic-universe", hook: "Two ideas wearing one name. Bohm's 'implicate order' where every part contains the whole — and the rigorous physics that a region of space can be encoded on its boundary. One is mysticism, one is mathematics, and telling them apart is the whole game", parents: ["simulation-hypothesis"] },
      { id: "cymatics", hook: "Draw a bow across a sand-strewn plate and the grains leap into symmetry. Sound becomes form. The ancient claim that the world is vibration — 'in the beginning was the Word' — given a demonstration you can watch, and an overreach worth naming", parents: ["nature-of-time"] },
      { id: "morphic-resonance", hook: "Rupert Sheldrake says nature has memory — that form and habit are shaped by every similar thing that came before, through fields no instrument has found. The journal Nature called his book the best candidate for burning in years. Suppressed pseudoscience, or a testable heresy?", parents: ["synchronicity"] },
      { id: "law-of-attraction", hook: "Think it and it comes. From 19th-century New Thought to Napoleon Hill to The Secret, the belief that consciousness shapes matter directly — folk idealism sold as technique, and the quiet cruelty hidden in its promise", parents: ["consciousness"] },
      { id: "noosphere", hook: "A Jesuit paleontologist, banned by his own Church, imagined the Earth growing a 'sphere of mind' converging on a single luminous point. A century later we built a global network of joined minds — and it looks less like his Omega Point than like something darker", parents: ["consciousness"] },
    ],
  },
];
