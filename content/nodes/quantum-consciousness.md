...
connections:
  - target: "consciousness"
    reason: "The quantum-mind program is the boldest attempt to give consciousness a place in fundamental physics rather than treating it as a late emergent byproduct of neural computation — it tries to write awareness directly into the equations of nature."
  - target: "hard-problem"
    reason: "Penrose invokes quantum gravity precisely because he believes no classical-computational account can bridge the explanatory gap. Orch-OR is an attempt to locate the hard problem in physics rather than dissolve it."
  - target: "simulation-hypothesis"
    reason: "The apparent observer-dependence of quantum outcomes — superpositions resolving only when measured — is read by some as a clue that reality is 'rendered' on demand, the same render-only-what-is-observed logic a simulation would use to save computation."
  - target: "cern"
    reason: "The LHC and the foundational quantum experiments are where the measurement problem physically lives; the interpretation debate — does observation collapse the wavefunction, and what counts as an observer — is a fight over what those detector results actually mean."
  - target: "panpsychism"
    reason: "If consciousness is woven into the quantum collapse process itself, it becomes a basic ingredient of nature present wherever wavefunctions reduce, rather than a property switched on only by biological brains — the quantum route to a panpsychist universe."
  - target: "holographic-universe"
    reason: "Both proposals demote the apparently solid world: each treats information and the act of observation as more fundamental than the material objects we take to be primary, with physical 'stuffness' a derived appearance."
  - target: "law-of-attraction"
    reason: "The Secret and What the Bleep borrow the language of observer-dependent quantum mechanics to dress belief as physics."
---
...
The question this node maps is whether he was following the equations or fooling himself — and the mainstream verdict, stated plainly up front, is that he was fooling himself. Consciousness-causes-collapse is a minority interpretation that most working physicists reject. But understanding *why* they reject it, and why a stubborn minority still does not, is one of the genuinely open seams between physics and the science of mind. The seam runs straight through the [[hard-problem]] of [[consciousness]], and that is exactly what makes it dangerous to dismiss too quickly.

## The measurement problem and the observer effect
...
## Von Neumann's chain and Wigner's friend
...
## The strongest counter: decoherence and the warm, wet brain
...
## What the program is really claiming
...
- von Neumann, John. *Mathematische Grundlagen der Quantenmechanik*. Berlin: Springer, 1932. English edition: *Mathematical Foundations of Quantum Mechanics*. Translated by Robert T. Beyer. Princeton: Princeton University Press, 1955.
- Wigner, Eugene P. "Remarks on the Mind-Body Question." In *The Scientist Speculates*, edited by I. J. Good, pp. 284–302. London: Heinemann, 1961.
- London, Fritz, and Bauer, Edmond. *La théorie de l'observation en mécanique quantique*. Paris: Hermann, 1939.
- Schrödinger, Erwin. "Die gegenwärtige Situation in der Quantenmechanik." *Naturwissenschaften*, Vol. 23, pp. 807–812, 823–828, 844–849, 1935.
...
- Hameroff, Stuart, and Penrose, Roger. "Orchestrated Reduction of Quantum Coherence in Brain Microtubules: A Model for Consciousness." *Mathematics and Computers in Simulation*, Vol. 40, No. 3–4, pp. 453–480, 1996.
- Hameroff, Stuart, and Penrose, Roger. "Consciousness in the Universe: A Review of the 'Orch OR' Theory." *Physics of Life Reviews*, Vol. 11, No. 1, pp. 39–78, 2014.
- Tegmark, Max. "Importance of Quantum Decoherence in Brain Processes." *Physical Review E*, Vol. 61, No. 4, pp. 4194–4206, 2000.
- Hagan, Scott, Hameroff, Stuart R., and Tuszyński, Jack A. "Quantum Computation in Brain Microtubules: Decoherence and Biological Feasibility." *Physical Review E*, Vol. 65, No. 6, 061901, 2002.
- Zeh, H. Dieter. "On the Interpretation of Measurement in Quantum Theory." *Foundations of Physics*, Vol. 1, No. 1, pp. 69–76, 1970.
- Zurek, Wojciech H. "Decoherence, Einselection, and the Quantum Origins of the Classical." *Reviews of Modern Physics*, Vol. 75, No. 3, pp. 715–775, 2003.
- Frauchiger, Daniela, and Renner, Renato. "Quantum Theory Cannot Consistently Describe the Use of Itself." *Nature Communications*, Vol. 9, Article 3711, 2018.
- Brukner, Časlav. "A No-Go Theorem for Observer-Independent Facts." *Entropy*, Vol. 20, No. 5, 350, 2018.
- Stapp, Henry P. *Mind, Matter and Quantum Mechanics*. 3rd edition. Berlin: Springer, 2009.
